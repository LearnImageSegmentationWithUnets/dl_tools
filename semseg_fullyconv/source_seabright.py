...
label_defs = [
    Label('anthro',     rgb2bgr((255,     0,   255))),
    Label('foam',       rgb2bgr((255,  255,   255))),
    Label('terrain',        rgb2bgr(( 102,   51,  0))),
    Label('water',          rgb2bgr((0,  0, 255))),
    Label('veg',      rgb2bgr((0,  255, 0))),
    Label('sand',       rgb2bgr((255, 255, 0))),
    Label('road',    rgb2bgr((255, 0, 0)))]
